...
static struct msm_platform_core_capability core_data_tuna_v0[] = {
	/* {type, value} */
...
static struct msm_platform_inst_capability instance_cap_data_tuna_v0[] = {
	...
	{CHROMA_QP_INDEX_OFFSET, ENC, H264 | HEVC,
...
static struct msm_platform_inst_capability instance_cap_data_tuna_v1[] = {
	/* {cap, domain, codec,
	 *      min, max, step_or_mask, value,
	 *      v4l2_id,
	 *      hfi_id,
...
static const struct bw_table tuna_bw_table[] = {
...
static const struct clk_rst_table tuna_clk_reset_table[] = {
	{ "video_axi_reset",        0  },
	{ "video_xo_reset",         1  },
	{ "video_mvs0c_reset",      0  },
	{ "video_mvs0_reset",       0  },
...
/* name, llcc_id */
static const struct subcache_table tuna_subcache_table[] = {
	{ "vidsc0",     LLCC_VIDSC0 },
};
...
/* freq */
static struct freq_table tuna_freq_table_sku0[] = {
	{533333333}, {444000000}, {366000000}, {338000000}, {240000000}, {192000000}
};

static struct freq_table tuna_freq_table_sku1[] = {
...
static const struct device_region_table tuna_device_region_table[] = {
	{
		"aon-registers",
...
/* decoder properties */
static const u32 tuna_vdec_psc_avc[] = {
	HFI_PROP_BITSTREAM_RESOLUTION,
	HFI_PROP_CROP_OFFSETS,
	HFI_PROP_CODED_FRAMES,
	HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
...
static const u32 tuna_vdec_psc_hevc[] = {
	HFI_PROP_BITSTREAM_RESOLUTION,
	HFI_PROP_CROP_OFFSETS,
	HFI_PROP_LUMA_CHROMA_BIT_DEPTH,
	HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
...
static const u32 tuna_vdec_psc_vp9[] = {
	HFI_PROP_BITSTREAM_RESOLUTION,
	HFI_PROP_CROP_OFFSETS,
	HFI_PROP_LUMA_CHROMA_BIT_DEPTH,
	HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
...
static const u32 tuna_vdec_psc_av1[] = {
	HFI_PROP_BITSTREAM_RESOLUTION,
	HFI_PROP_CROP_OFFSETS,
	HFI_PROP_LUMA_CHROMA_BIT_DEPTH,
	HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
...
static const u32 tuna_vdec_input_properties_avc[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
	HFI_PROP_DPB_LIST,
};

static const u32 tuna_vdec_input_properties_hevc[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
	HFI_PROP_DPB_LIST,
};

static const u32 tuna_vdec_input_properties_vp9[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
	HFI_PROP_DPB_LIST,
};

static const u32 tuna_vdec_input_properties_av1[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
	HFI_PROP_DPB_LIST,
...
static const u32 tuna_vdec_output_properties_avc[] = {
...
static const u32 tuna_vdec_output_properties_hevc[] = {
	HFI_PROP_WORST_COMPRESSION_RATIO,
	HFI_PROP_WORST_COMPLEXITY_FACTOR,
	HFI_PROP_PICTURE_TYPE,
	HFI_PROP_FENCE,
...
static const u32 tuna_vdec_output_properties_vp9[] = {
	HFI_PROP_WORST_COMPRESSION_RATIO,
	HFI_PROP_WORST_COMPLEXITY_FACTOR,
	HFI_PROP_PICTURE_TYPE,
	HFI_PROP_FENCE,
...
static const u32 tuna_vdec_output_properties_av1[] = {
	HFI_PROP_WORST_COMPRESSION_RATIO,
	HFI_PROP_WORST_COMPLEXITY_FACTOR,
	HFI_PROP_PICTURE_TYPE,
	HFI_PROP_FENCE,
...
static const u32 tuna_msm_vidc_ssr_type[] = {
...
static struct msm_vidc_efuse_data efuse_data_tuna[] = {
	/* IRIS_FMAX_LIMIT_UHD60, SKU VERSION: 1 */
	EFUSE_ENTRY(0x221C8114, 4, 0x20000000, 0x1D, SKU_VERSION),
};

static const struct msm_vidc_platform_data tuna_data_v0 = {
	...
	.subcache_tbl_size = ARRAY_SIZE(tuna_subcache_table),

	/* populate context bank */
	.context_bank_tbl = tuna_context_bank_table,
	.context_bank_tbl_size = ARRAY_SIZE(tuna_context_bank_table),

	/* platform specific resources */
	.freq_tbl = tuna_freq_table_sku0,
	.freq_tbl_size = ARRAY_SIZE(tuna_freq_table_sku0),
	.reg_prst_tbl = tuna_reg_preset_table,
	...
	.core_data = core_data_tuna_v0,
	.core_data_size = ARRAY_SIZE(core_data_tuna_v0),
	.inst_cap_data = instance_cap_data_tuna_v0,
	.inst_cap_data_size = ARRAY_SIZE(instance_cap_data_tuna_v0),
	...
	.psc_avc_tbl = tuna_vdec_psc_avc,
	.psc_avc_tbl_size = ARRAY_SIZE(tuna_vdec_psc_avc),
	.psc_hevc_tbl = tuna_vdec_psc_hevc,
	...
	.efuse_data = efuse_data_tuna,
	.efuse_data_size = ARRAY_SIZE(efuse_data_tuna),
	.sku_version = SKU_VERSION_0,
};

static const struct msm_vidc_platform_data tuna_data_v1 = {
	/* resources dependent on other module */
	.bw_tbl = tuna_bw_table,
	.bw_tbl_size = ARRAY_SIZE(tuna_bw_table),
	.pd_tbl = tuna_pd_table,
	...
	/* platform specific resources */
	.freq_tbl = tuna_freq_table_sku1,
	.freq_tbl_size = ARRAY_SIZE(tuna_freq_table_sku1),
	.reg_prst_tbl = tuna_reg_preset_table,
	.reg_prst_tbl_size = ARRAY_SIZE(tuna_reg_preset_table),
	.dev_reg_tbl = tuna_device_region_table,
	.dev_reg_tbl_size = ARRAY_SIZE(tuna_device_region_table),
	...
	/* caps related resorces */
	.core_data = core_data_tuna_v1,
	.core_data_size = ARRAY_SIZE(core_data_tuna_v1),
	.inst_cap_data = instance_cap_data_tuna_v1,
	.inst_cap_data_size = ARRAY_SIZE(instance_cap_data_tuna_v1),
	.inst_cap_dependency_data = instance_cap_dependency_data_tuna,
	.inst_cap_dependency_data_size = ARRAY_SIZE(instance_cap_dependency_data_tuna),
	.csc_data.vpe_csc_custom_bias_coeff = vpe_csc_custom_bias_coeff,
	.csc_data.vpe_csc_custom_matrix_coeff = vpe_csc_custom_matrix_coeff,
...
static int msm_vidc_init_data(struct msm_vidc_core *core)
{
	...
	core->platform->data = tuna_data_v0;
	...
	if (core->platform->data.sku_version == SKU_VERSION_1)
		core->platform->data = tuna_data_v1;
