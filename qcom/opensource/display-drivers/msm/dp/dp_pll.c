...
static const struct dp_pll_ver_spec_info dp_pll_4nm_v1 = {
	.revision = DP_PLL_4NM_V1,
};

static const struct dp_pll_ver_spec_info dp_pll_4nm_v1_1 = {
